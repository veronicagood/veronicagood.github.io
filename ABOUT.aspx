<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ABOUT.aspx.cs" Inherits="TIENDA.ABOUT" %>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="right-content">
              <h4>&nbsp;</h4>
              <p>
                  <asp:Label ID="Label1" runat="server" BackColor="#FFCCCC" Text="Label" 
                      Width="96px"></asp:Label>
&nbsp;&nbsp; FELICIDADES!!!&nbsp;&nbsp; BIENVENIDO A LA COMUNIDAD GOOD GUYS </p>
              <br>
              <p>&nbsp;<asp:ImageButton ID="ImageButton1" runat="server" Height="107px" 
                      ImageUrl="assets/images/loli.jpg" onclick="ImageButton1_Click" Width="207px" />
                </p>
              <br>
